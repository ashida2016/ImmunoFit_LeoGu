...
class User(db.Model):
    ...
    role = db.Column(db.String(20), nullable=False, default='patient')  # 'patient' or 'researcher'
    display_name = db.Column(db.String(100))
    linked_patient_id = db.Column(db.Integer, db.ForeignKey('patient.id'), nullable=True)
